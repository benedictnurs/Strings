              ...
              <>
                <SignUp.Step name="start">
                  <Card className="w-full sm:w-96 rounded-none">
                    <CardHeader>
                      <CardTitle className="font-regular text-xl">Create your account</CardTitle>
                      <CardDescription>
                    ...
                    <CardFooter>
                      <div className="grid w-full gap-y-4">
                        ...
                        <SignUp.Action submit asChild>
                          <Button disabled={isGlobalLoading} className="text-primary-foreground hover:bg-primary/90 bg-primary">
                            <Clerk.Loading className>
                              {(isLoading) => {
                                return isLoading ? (
                                  <Icons.spinner className="size-4 animate-spin" />
                                ) : (
